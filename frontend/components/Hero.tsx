    ...
    <section className="max-w-5xl mx-auto px-4 sm:px-12 py-16 sm:py-28">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 sm:gap-16 items-center">
        ...
        <div>
          ...
          <h1 className="font-serif text-4xl sm:text-5xl font-normal leading-tight tracking-tight text-ink mb-6">
            Contratos{" "}
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
            <Link
              href="/registro"
              className="text-sm font-medium uppercase tracking-widest px-8 py-3 bg-ink text-cream hover:bg-green transition-colors w-full sm:w-auto text-center"
            >
              Empezar gratis
            </Link>
            <Link
